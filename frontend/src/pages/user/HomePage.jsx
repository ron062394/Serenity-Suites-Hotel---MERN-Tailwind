...
function HomePage() {
  ...
  return (
    <div className="bg-gray-50">
      <section id="hero" className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] overflow-hidden bg-cover bg-center transition-all duration-1000 ease-in-out"
               style={{
      ...
      <section className="relative z-20 -mt-16 sm:-mt-20 md:-mt-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6 md:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-emerald-800">Experience Luxury</h2>
            <p className="text-base sm:text-lg text-emerald-700 mb-4 sm:mb-6">Discover our world-class amenities and unparalleled service.</p>
            <Link to="/rooms" className="inline-block px-4 sm:px-6 py-2 text-base sm:text-lg font-semibold text-white bg-emerald-600 rounded-md shadow-lg hover:bg-emerald-700 transition-all duration-300 ease-in-out transform hover:scale-105">
              Explore Our Rooms
            </Link>
          </div>
        </div>
      ...
      <section id="amenities" className="py-16 sm:py-20 md:py-24 bg-emerald-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <motion.div 
              className="col-span-1 sm:col-span-2 bg-white rounded-lg shadow-md overflow-hidden"
              whileHover={{ scale: 1.05 }}
            >
              ...
              <div className="p-4 sm:p-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-emerald-800">Rejuvenating Spa</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="relative w-full md:w-2/3 overflow-hidden rounded-lg shadow-xl mb-8 md:mb-0">
              ...
              <button 
                className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white text-amber-600 p-2 sm:p-3 rounded-full opacity-75 hover:opacity-100 transition-opacity duration-300"
              ...
              <button 
                className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white text-amber-600 p-2 sm:p-3 rounded-full opacity-75 hover:opacity-100 transition-opacity duration-300"
          ...
          <div className="mt-6 flex justify-center space-x-2">
            {galleryImages.map((_, index) => (
              <button
                key={index}
                className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${index === galleryIndex ? 'bg-white' : 'bg-white bg-opacity-50'}`}
      ...
      <section id="testimonials" className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 sm:mb-12 text-center text-emerald-800">Guest Stories</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            {[
              ...
              <motion.div 
                key={index} 
                className="bg-emerald-50 p-6 sm:p-8 rounded-lg shadow-md"
                whileHover={{ scale: 1.05 }}
              >
                <p className="text-base sm:text-lg mb-4 italic text-emerald-800">{testimonial.text}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <motion.div 
                key={index}
                className="bg-emerald-50 p-6 sm:p-8 rounded-lg shadow-lg text-center transition-all duration-300"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {[
                ...
                <motion.div 
                  key={index}
                  className="bg-emerald-700 p-4 sm:p-6 rounded-lg shadow-md"
